// (#Webtir) This file was generated by transform-figma-tokens.ts from ./src/__generated__/figma-design-tokens.json
// ! HOWEVER, palette generation is not used right now, the file is moved out of __generated__ folder
// This was made to be able to update colors in this file manually without risk of losing them
